...
public abstract class Camera1Base
   ...
   * @param password auth.
   */
  public abstract void setAuthorization(String user, String password,String user1, String password1);
  ...
  protected abstract void getAacDataRtp2(ByteBuffer aacBuffer, MediaCodec.BufferInfo info);
